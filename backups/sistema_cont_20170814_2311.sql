...
-- Tiempo de generación: 14-08-2017 a las 21:11:36
...
(260, '5102200003', 'EGRESO', 'GASTOS ELECTRONICOS (AES-MIAMI)', 'S', 'BS'),
...
CREATE TABLE IF NOT EXISTS `operaciones` (
  ...
  `haber` int(11) unsigned DEFAULT NULL,
...
(1, '30', 'test de operacion', 500, 0, 1),
(2, '38', 'test de haber', 0, 50, 1),
(3, '24', 'test b', 12.5, 0, 2),
(4, '29', 'CAJA', 5000, 0, 3),
(5, '26', 'CAJA', 5000, 0, 4),
(6, '185', 'VENTAS', 0, 5000, 4),
(7, '26', '', 45, 0, 5),
(8, '28', '', 0, 46, 5),
(9, '139', '', 2917.9, 0, 7),
(10, '{', NULL, 50, 0, 8),
...
(1, 1, 1, 1, '2017-08-21', 0, '', ''),
(2, 2, 1, 2, '2017-07-30', 0, '', ''),
(3, 3, 2, 1, '2017-08-03', 0, '', ''),
(4, 4, 3, 1, '2017-08-02', 0, '', ''),
(5, 5, 4, 1, '2017-08-11', 0, '', ''),
(6, 6, 2, 2, '2017-01-09', 0, '', ''),
(7, 6, 2, 2, '2017-02-06', 0, '', ''),
(8, 7, 5, 1, '2017-08-14', 0, '', 'Prueba de errores'),
(9, 8, 6, 1, '2017-08-14', 0, '', 'prueba 1'),
(10, 9, 7, 1, '2017-08-14', 0, '', 'Prueba 2');
